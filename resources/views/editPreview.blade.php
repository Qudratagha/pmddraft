  ...
  <body>
    ...
    <div class="d-flex-end">
      <div class="info">
        ...
        <div class=" mb-0">
          <b>Property Code:{{ $cusDetails['property_code'] }}</b>
        </div>
    ...
    <div class="d-flex-between">
      ...
      <div class="d-inline-block" style="margin-left:20px">
          <article>{{$cusDetails['name']}} {{$cusDetails['relation_title']}} {{$cusDetails['So_Do_Wo']}}</article>
          <article>({{ $cusDetails['cnic_nicop'] }})</article>
          <article>{{ $cusDetails['present_address'] }}</article>
          <article>{{ $cusDetails['phone_no'] }}</article>
      </div>
      <div></div>
    ...
    <div><span>DHAQ Membership No. {{ $cusDetails['membership_prefix_no'] }}</span></div>
